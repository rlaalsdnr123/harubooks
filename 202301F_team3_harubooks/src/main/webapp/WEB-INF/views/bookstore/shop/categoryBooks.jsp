            ...
            <div class="d-md-flex justify-content-between align-items-center py-4">
            	<c:choose>
            		<c:when test="${empty pagingVO.ccg_b002 and empty pagingVO.ccg_b003 }">
            			<h1 class="page-title font-size-3 font-weight-medium m-0 text-lh-lg" style="border: 1px solid #5055b1; width: 50px;text-align: center;color: white; background:#5055b1;border-radius: 10px; ">검색</h1>
